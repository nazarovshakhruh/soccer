  ...
  match.home_goals === null || match.away_goals === null
    ...
    match.events.forEach(ev => {
      if (["goal", "own_goal", "penalty"].includes(ev.type)) {
        ...
        const assistText =
          (ev.type === "goal" && assist)
            ? ` <img class="musr" src="/assets/assist.png" style="width:30px;height:30px"> <a href="/players/${slugify(assist.name)}">${assist.name}</a>`
            : "";
